...
const AdminCollections = props => {
    ...
    collectAll !== null &&
        ...
        Object.keys(collectAll)?.map(element => {
            ...
            if (collectAll[key] !== null) {
                ...
                const image = collectAll[key].image ? collectAll[key].image : ''
    ...
    //Cập nhật link hình vào setEditCollectionObject
    useEffect(() => {
        setEditCollectionObject(prevState => ({
            ...prevState,
            image: result,
                            ...
                            <Table sx={{ minWidth: 700 }} aria-label='customized table'>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <StyledTableCell align='left'>Hình</StyledTableCell>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <Grid container spacing={2}>
                                                    <Grid item xs={3}>
                                                        <img src={editCollectionObject.image} alt='/' loading='lazy' />
                                                    </Grid>
                                                    <Grid item xs={4}>
