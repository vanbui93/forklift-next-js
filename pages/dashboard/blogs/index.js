...
function AdminPage(props) {
    ...
    const [editBlogObject, setEditBlogObject] = useState({
        title: '',
        image: '',
        slug: '',
        content: '',
    ...
    const handleAddAccount = () => {
        router.push('/dashboard/blog_add')
    }
    ...
    const handleEditSubmit = async () => {
        try {
            dispatch(updateBlogDetail(editBlogObject))
            setIsEdit(false)
            dispatch(getBlog())
        } catch (err) {
            console.log(err)
    ...
    //Cập nhật link hình vào setEditBlogObject
    useEffect(() => {
        setEditBlogObject(prevState => ({
            ...prevState,
            image: result,
    ...
    useEffect(() => {
        const results = allList?.filter(e => {
            ...
            <LayoutAdmin>
                ...
                {!isEdit ? (
                                            ...
                                            (post, idx) =>
                                                ...
                                                post !== undefined && (
                                                    <StyledTableRow key={idx}>
                                                        ...
                                                        <StyledTableCell align='left'>{post.slug}</StyledTableCell>
                    ...
                    <Grid ref={refs}>
                        <TableContainer component={Paper}>
                            <Table>
                                {editBlogObject !== null && editBlogObject !== undefined && (
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <TextField
                                                    ...
                                                    size='small'
                                                    fullWidth
                                                    defaultValue={editBlogObject.title}
                                                    name='title'
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                <Grid container spacing={2}>
                                                    <Grid item xs={3}>
                                                        <img src={editBlogObject.image} alt='/' loading='lazy' />
                                                    </Grid>
                                                    <Grid item xs={4}>
                                            ...
                                            <TableCell>
                                                <FormControl>
                                                    <RadioGroup
                                                        ...
                                                        name='isDisplay'
                                                        value={editBlogObject.isDisplay}
                                                        onChange={handleEditOnchage}
                                                    >
